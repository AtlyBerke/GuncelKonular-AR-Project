...
export default function InstructionScreen3({ navigation }) {
  ...
  return (
    <ImageBackground source={require('../assets/images/turkish_airlines_logo.png')} style={styles.container}>
      ...
      <Animated.Text style={[styles.stepText, { opacity: fadeInStep, transform: [{ translateY: slideIn }] }]}>
        <Text style={styles.redText}>Adım 3: </Text>
        <Text style={styles.normalText}>Sayıların karesini ve küpünü hesapla ardından o </Text>
        <Text style={styles.redText}>sayıyı bul !</Text>
      </Animated.Text>
